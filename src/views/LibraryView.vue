...
<template>
  <div class="p-8">
      ...
      <div class="w-full ml-5">
        ...
        <div class="absolute flex gap-4 items-center justify-start bottom-0 mb-1.5">
          <button class="p-1 rounded-full bg-white">
            <Play v-if="true" fill-color="#181818" :size="25"></Play>
            <Play v-else fill-color="#181818" :size="25"></Play>
          </button>
          <button>
            <Heart fill-color="#1BD760" :size="30"></Heart>
          </button>
          <button>
            <DotsHorizontal fill-color="#FFFFFF" :size="25"></DotsHorizontal>
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="flex items-center justify-between px-5 pt-2">
      ...
      <div>
        <ClockTimeThreeOutline fill-color="#FFFFFF" :size="18"></ClockTimeThreeOutline>
      </div>
    </div>
