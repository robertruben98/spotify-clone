...
<template>
    ...
    <button
      ...
      <div class="flex items-center">
        <img
            ...
            class="rounded-full"
            width="27"
            src="https://yt3.googleusercontent.com/yti/ANjgQV_Yh-KwvGNX8cn4Q67_Gi10NeBNncl50D_wIJnHAxgVqQ=s88-c-k-c0x00ffffff-no-rj"
        >
        <div class="text-white text-[14px] ml-1.5 font-semibold">RobertDev</div>
  ...
  >
    ...
    <ul>
      <li class="cursor-pointer font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #1</li>
      <li class="cursor-pointer font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #2</li>
      <li class="cursor-pointer font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #3</li>
      <li class="cursor-pointer font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #4</li>
    </ul>
  </div>
